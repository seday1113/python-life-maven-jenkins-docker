...
<body>
  <marquee behavior="scroll" direction="left" style="background-color: #e74c3c; color: white; padding: 10px;">
    Learn Here and Lead Any Where.  Pythonlife-DevSecOps && AI and AWS-CLOUD , we don't just teach skills, we ignite careers. Join us and discover the limitless opportunities awaiting you in the world of Python and DevOps - Welcome to PYTHONLIFE-DEVOPS - Your gateway to Python and DevOps expertise!
  </marquee>
  ...
  <div class="course-details" id="courseDetails" style="display: none;">
    ...
    <table>
      ...
      <tr>
        <td style="background-color: #f7e3b6;">R Programming </td>
      </tr>
      <tr>
